...
function um_profile_header( $args ) {
	...
	<div class="um-header<?php echo esc_attr( $classes ); ?>">
        ...
        <div class="photo-text-set">
		<div class="um-profile-photo" data-user_id="<?php echo esc_attr( um_profile_id() ); ?>">
            <div class="main-name-set">
                <div class="right-name-set">
		    ...
		    <?php  if ( um_is_on_edit_profile() || UM()->user()->preview ) {  ?>
					...
					<?php } else { ?>
                        <div class="profile-data">
							<div class="leftprofile-data">
								 <h1 class="profile-name"><?php echo esc_attr( um_user( 'display_name' ) ); ?></h1>
								 <h2 class="profile-name"><?php echo esc_attr( um_user( 'country' ) ); ?></h2>
							</div>
						</div>
			...
			<?php } else { ?>
			<div class="um-profile-chat-options">
				<div class="main-setchats-section">
					<div class="message-chat user-chat-boxes">
						<!--<span><a href="<?php echo get_site_url(); ?>/user/<?php echo esc_attr( um_user( 'display_name' ) ); ?>/?profiletab=messages">Chats</a></span>-->
						<span><a href="javascript:void(0);" class="um-message-btn um-button active" data-message_to="<?php echo esc_attr( um_user( 'ID' ) ); ?>" title="Message">Message</a></span>

					</div>
					<div class="bookmarks-chat user-chat-boxes">
						<span><a href="<?php echo get_site_url(); ?>/user/<?php echo esc_attr( um_user( 'display_name' ) ); ?>/?profiletab=bookmarks">Bookmarks</a></span>
					</div>
					<div class="qr-code user-chat-boxes">
						<span><div type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModals"><span>My QR code</span></span></div>	
				    </div>
					<div id ="myqrcode" style="display:none">
								<?php echo get_site_url(); ?>/user/<?php echo esc_attr( um_user( 'display_name' ) ); ?>
  ...
  <!-- The Modal -->
  <div class="modal qur-code-hover" id="myModals">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <img id='barcode' src="https://api.qrserver.com/v1/create-qr-code/?data=<?php echo get_site_url(); ?>/user/<?php echo esc_attr( um_user( 'display_name' ) ); ?>&amp;size=100x100" alt="<?php echo esc_attr( um_user( 'display_name' ) ); ?>" title="<?php echo esc_attr( um_user( 'display_name' ) ); ?>" width="200" height="200" />
        </div>

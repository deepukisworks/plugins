...
class EH_Afterpay extends WC_Payment_Gateway {
    ...
    public function init_form_fields() {
        ...
        $this->form_fields = array(
            ...
            'eh_afterpay_desc' => array(
                'type' => 'title',
                'description' => sprintf(__('%sSupported currencies: %sUSD, CAD, GBP, AUD, NZD%sStripe accounts in the following countries can accept the payment: %sAustralia, Canada, Ireland, New Zealand, United Kingdom, United States%s %sRead documentation%s', 'payment-gateway-stripe-and-woocommerce-integration'), '<div class="wt_info_div"><ul><li>', '<b>', '</b></li><li>', '<b>', '</b></li></ul></div>', '<p><a target="_blank" href="https://www.webtoffee.com/woocommerce-stripe-payment-gateway-plugin-user-guide/#afterpay">', '</a></p>'),
            ),
    ...
    public function get_charge_details( $wc_order, $client, $currency, $amount, $payment_method) {
       ...
       return apply_filters('eh_afterpay_payment_intent_args', $charge);
    }

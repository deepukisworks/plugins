	...
	<div class="um-reviews-post review-form">
		...
		<form class="um-reviews-form" action="" method="post">
			...
			<span class="um-reviews-title">
				<input type="text" name="title" class="form-control" placeholder="<?php esc_attr_e( 'Enter subject...', 'um-reviews' ); ?>" value="<?php echo esc_attr( $post->post_title ); ?>" maxlength="80" />
			</span>
			...
			<span class="um-reviews-content">
				<textarea name="content" class="form-control" placeholder="<?php esc_attr_e( 'Enter your review...', 'um-reviews' ); ?>"><?php echo esc_textarea( $content ); ?></textarea>
			</span>

<div class="card proad">
    <div class="cardcontent">
        ...
        <p><b><?php _e('&#128161; Synchronize files', 'wpsynchro'); ?></b> - <?php _e('Such as uploads, plugins, themes or even specific files. Only difference in files is transferred, making it really fast.', 'wpsynchro'); ?></p>
        ...
        <p><b><?php _e('&#128161; Email notifications', 'wpsynchro'); ?></b> - <?php _e('So you know when synchronizations went well and when they did not.', 'wpsynchro'); ?></p>

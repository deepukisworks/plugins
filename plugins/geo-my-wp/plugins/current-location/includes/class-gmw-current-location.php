...
class GMW_Current_Location {
	...
	public function address() {
		...
		$output .= '<span class="address-holder gjg">' . stripslashes( esc_html( $this->user_position['address'] ) ) . '</span>';
		
 		$output .= '<input type="hidden" class="lat_custom_cls" value="'.$this->user_position['lat'] .'"  name="Latitude">';
		
		$output .= '<input type="hidden" class="lng_xutom_cls" value="'.$this->user_position['lng'].'" name="Longitude">';
	
		$output .= '<input type="hidden" class="address_custom_get" value="'. stripslashes( esc_html( $this->user_position['address'] ) ) .'" name="Address">';

		$output .= '<input type="hidden" class="formatted_address" value="'. stripslashes( esc_html( $this->user_position['address'] ) ) .'" name="formatted_address">';

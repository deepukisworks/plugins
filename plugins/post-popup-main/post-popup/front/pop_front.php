          ...
          <div class="popup-author-wrapper">
            ...
            <div class="author-block">
              <div class="author-name-block">
                <div div class="popup-author-img wwww">
                  <?php
                  ...
                  <a href='<?php echo site_url(); ?>/user/<?php echo $author; ?>' target='_blank'><?php echo $author_obj->display_name; ?>
                    <?php apply_filters('previewRender', $author_meta['user_avatar_url'][0] ); ?>
                  </a>
                </div>
              ...
              <div class="honey_pot">
                ...
                <div class="honey_pot_detail">
                  <ul>
                    ...
                    <li>
                      <a href="#" class="honey_check verify_percentage" data-post="<?php echo $id; ?>;">
                  ...
                  <script type="text/javascript">
                    $(document).ready(function() {
                      ...
                      function makeTimer() {
                        ...
                        // $("#days1_<?php //echo $post_id; 
                                      ?>").html(days + "<span>d:</span>");
                        // $("#hours1_<?php //echo $post_id; 
                                      ?>").html(hours + "<span>h:</span>");
                        // $("#minutes1_<?php //echo $post_id; 
                                        ?>").html(minutes + "<span>m</span>");
